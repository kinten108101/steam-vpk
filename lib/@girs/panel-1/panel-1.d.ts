...
const WIDGET_KIND_ANY: string | null
const WIDGET_KIND_DOCUMENT: string | null
const WIDGET_KIND_UNKNOWN: string | null
const WIDGET_KIND_UTILITY: string | null
...
function init(): void
function marshal_BOOLEAN__OBJECT_OBJECT(closure: GObject.TClosure, return_value: any, n_param_values: number, param_values: any, invocation_hint: any | null, marshal_data: any | null): void
function marshal_OBJECT__OBJECT(closure: GObject.TClosure, return_value: any, n_param_values: number, param_values: any, invocation_hint: any | null, marshal_data: any | null): void
 ...
 * @interface 
 */
class FrameHeader extends GObject.Object {
    static name: string
...
interface ActionMuxer extends Gio.ActionGroup {
    /**
...
module Application {
    interface ConstructorProperties extends Gio.ActionGroup.ConstructorProperties, Gio.ActionMap.ConstructorProperties, Adw.Application.ConstructorProperties {
    }
...
module Dock {
     ...
     */
    interface AdoptWidgetSignalCallback {
     ...
     */
    interface CreateFrameSignalCallback {
     ...
     */
    interface PanelDragBeginSignalCallback {
     ...
     */
    interface PanelDragEndSignalCallback {
        ($obj: Dock, panel: Widget): void
    }
...
interface Dock extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
...
interface DocumentWorkspace extends Gio.ActionGroup, Gio.ActionMap, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager {
    readonly dock: Dock
    readonly grid: Grid
...
module Frame {
     ...
     */
    interface PageClosedSignalCallback {
...
interface Frame extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
...
module FrameHeaderBar {
    interface ConstructorProperties extends Gtk.Accessible.ConstructorProperties, Gtk.Buildable.ConstructorProperties, Gtk.ConstraintTarget.ConstructorProperties, FrameHeader.ConstructorProperties, Gtk.Widget.ConstructorProperties {
        /**
...
interface FrameHeaderBar extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, FrameHeader {
    /**
     * Whether to show the icon or not.
     */
    show_icon: boolean
...
module FrameSwitcher {
    interface ConstructorProperties extends Gtk.Accessible.ConstructorProperties, Gtk.Buildable.ConstructorProperties, Gtk.ConstraintTarget.ConstructorProperties, Gtk.Orientable.ConstructorProperties, FrameHeader.ConstructorProperties, Gtk.Widget.ConstructorProperties {
    }

}

interface FrameSwitcher extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable, FrameHeader {
...
interface FrameTabBar extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, FrameHeader {
    /**
     * Whether the tabs automatically hide.
     */
    autohide: boolean
...
interface GSettingsActionGroup extends Gio.ActionGroup {
...
interface Grid extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    parent_instance: Gtk.Widget & GObject.InitiallyUnowned
    /**
...
interface GridColumn extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    /**
...
interface OmniBar extends Gtk.Accessible, Gtk.Actionable, Gtk.Buildable, Gtk.ConstraintTarget {
    /**
     * The tooltip for the action.
     */
    action_tooltip: string | null
...
interface Paned extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Orientable {
    /**
...
module SaveDelegate {
     ...
     */
    interface DiscardSignalCallback {
        ($obj: SaveDelegate): void
    }
...
interface SaveDialog extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager {
    /**
     * This property requests that the widget close after saving.
     */
...
interface Settings extends Gio.ActionGroup {
    /**
     * The "identifier" property is used to make unique paths.
     * 
     * This might be a unique "project-id" for example, in an IDE.
...
interface Statusbar extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    /**
...
interface ThemeSelector extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    /**
     * The name of the action activated on activation.
     */
    action_name: string | null
...
interface ToggleButton extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    /**
     * The area this button will reveal.
     */
    readonly area: Area
...
module Widget {
     ...
     */
    interface GetDefaultFocusSignalCallback {
...
interface Widget extends Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
...
module Workbench {
    ...
    interface ConstructorProperties extends Gtk.WindowGroup.ConstructorProperties {
        /**
...
interface Workspace extends Gio.ActionGroup, Gio.ActionMap, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget, Gtk.Native, Gtk.Root, Gtk.ShortcutManager {
    /**
     * The "id" of the workspace.
     * 
     * This is generally used by applications to help destinguish between
...
interface ActionMuxerClass {
    parent_class: GObject.ObjectClass
}

abstract class ActionMuxerClass {
    static name: string
}
...
interface FrameHeaderBarClass {
    parent_class: Gtk.WidgetClass
}

abstract class FrameHeaderBarClass {
    static name: string
}

interface FrameHeaderInterface {
...
abstract class FrameHeaderInterface {
    static name: string
}

interface FrameSwitcherClass {
    parent_class: Gtk.WidgetClass
}

abstract class FrameSwitcherClass {
    static name: string
}

interface FrameTabBarClass {
    parent_class: Gtk.WidgetClass
}

abstract class FrameTabBarClass {
    static name: string
}

interface GSettingsActionGroupClass {
    parent_class: GObject.ObjectClass
}

abstract class GSettingsActionGroupClass {
    static name: string
}
...
interface GridColumnClass {
    parent_class: Gtk.WidgetClass
}

abstract class GridColumnClass {
    static name: string
}

interface InhibitorClass {
    parent_class: GObject.ObjectClass
}

abstract class InhibitorClass {
    static name: string
}

interface LayeredSettingsClass {
    parent_class: GObject.ObjectClass
}

abstract class LayeredSettingsClass {
    static name: string
}
...
abstract class PositionClass {
    static name: string
}

interface SaveDelegateClass {
    parent_class: GObject.ObjectClass
...
abstract class SaveDelegateClass {
    static name: string
}

interface SaveDialogClass {
    parent_class: Adw.MessageDialogClass
}

abstract class SaveDialogClass {
    static name: string
}
...
interface SessionItemClass {
    parent_class: GObject.ObjectClass
}

abstract class SessionItemClass {
    static name: string
}
...
interface ThemeSelectorClass {
    parent_class: Gtk.WidgetClass
}

abstract class ThemeSelectorClass {
    static name: string
}
