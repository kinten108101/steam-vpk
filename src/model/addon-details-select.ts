...
import { RepositoryItem } from './repository.js';

export default interface AddonDetailsSelectModel {
...
export default class AddonDetailsSelectModel extends GObject.Object {
  static {
