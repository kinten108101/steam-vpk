...
import { AddonEntry, AddonlistItem } from '../model/addonlist.js';
...
export class LaunchpadPage extends Adw.Bin {
  static {
    GObject.registerClass({
      ...
      Template: `resource://${APP_RDNN}/ui/launchpad-page.ui`,
      Children: [
        'addonlist_box',
        'stack',
      ],
  ...
  _setup_boxedlist() {
    if (this.loadorder === null) return;
    this.addonlist_box.bind_model(this.loadorder, (item: GObject.Object) => {
      if (!(item instanceof AddonlistItem)) throw new Error;
